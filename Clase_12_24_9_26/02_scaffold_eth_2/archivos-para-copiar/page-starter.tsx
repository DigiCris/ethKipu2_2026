...
export default function Home() {
  ...
  // PASO 4: agregar useScaffoldReadContract para leer number().

  // PASO 5: agregar useScaffoldWriteContract para increment/decrement.
      ...
      <div className="card w-full max-w-xl bg-base-100 shadow-xl">
        <div className="card-body gap-5">
          <div>
            ...
            <p className="opacity-70">El frontend ya está armado. Completamos únicamente los hooks Web3.</p>
          </div>
          ...
          <div className="rounded-box border border-base-300 p-8 text-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="btn" onClick={() => alert("TODO decrement")}>− Decrement</button>
              <button className="btn btn-primary" onClick={() => alert("TODO increment")}>+ Increment</button>
            </div>
          </div>
        </div>
      </div>
